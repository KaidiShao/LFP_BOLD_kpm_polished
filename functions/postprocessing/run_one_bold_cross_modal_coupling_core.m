...
if params.skip_existing_xcorr && exist(candidate.xcorr_file, 'file') == 2 && ...
        local_saved_xcorr_matches_density_sources(candidate.xcorr_file, density_sources)
...
function tf = local_saved_xcorr_matches_density_sources(xcorr_file, density_sources)
tf = false;
try
    S = load(xcorr_file, 'out');
