...
cfg.thresholded_density.value_transform = params.density_value_transform;
cfg.thresholded_density.lfp_activity_transform = params.lfp_activity_transform;
cfg.thresholded_density.lfp_activity_window_policy = params.lfp_activity_window_policy;
cfg.thresholded_density.envelope_enable = params.envelope_enable;
cfg.thresholded_density.envelope_policy = params.envelope_policy;
cfg.thresholded_density.envelope_alpha = params.envelope_alpha;
cfg.thresholded_density.envelope_min_window_sec = params.envelope_min_window_sec;
cfg.thresholded_density.envelope_max_window_sec = params.envelope_max_window_sec;
cfg.thresholded_density.envelope_fallback_window_sec = params.envelope_fallback_window_sec;
...
cfg.thresholded_events.value_transform = params.density_value_transform;
cfg.thresholded_events.lfp_activity_transform = params.lfp_activity_transform;
cfg.thresholded_events.lfp_activity_window_policy = params.lfp_activity_window_policy;
cfg.thresholded_events.envelope_enable = params.envelope_enable;
cfg.thresholded_events.envelope_policy = params.envelope_policy;
cfg.thresholded_events.envelope_alpha = params.envelope_alpha;
cfg.thresholded_events.envelope_min_window_sec = params.envelope_min_window_sec;
cfg.thresholded_events.envelope_max_window_sec = params.envelope_max_window_sec;
cfg.thresholded_events.envelope_fallback_window_sec = params.envelope_fallback_window_sec;
...
cfg.dimred_thresholded_density.value_transform = params.density_value_transform;
cfg.dimred_thresholded_density.lfp_activity_transform = params.lfp_activity_transform;
cfg.dimred_thresholded_density.lfp_activity_window_policy = params.lfp_activity_window_policy;
cfg.dimred_thresholded_density.envelope_enable = params.envelope_enable;
cfg.dimred_thresholded_density.envelope_policy = params.envelope_policy;
cfg.dimred_thresholded_density.envelope_alpha = params.envelope_alpha;
cfg.dimred_thresholded_density.envelope_min_window_sec = params.envelope_min_window_sec;
cfg.dimred_thresholded_density.envelope_max_window_sec = params.envelope_max_window_sec;
cfg.dimred_thresholded_density.envelope_fallback_window_sec = params.envelope_fallback_window_sec;
cfg.dimred_thresholded_density.component_timescale_weight_transform = params.component_timescale_weight_transform;
cfg.dimred_thresholded_density.component_timescale_top_modes = params.component_timescale_top_modes;
...
cfg.dimred_thresholded_events.value_transform = params.density_value_transform;
cfg.dimred_thresholded_events.lfp_activity_transform = params.lfp_activity_transform;
cfg.dimred_thresholded_events.lfp_activity_window_policy = params.lfp_activity_window_policy;
cfg.dimred_thresholded_events.envelope_enable = params.envelope_enable;
cfg.dimred_thresholded_events.envelope_policy = params.envelope_policy;
cfg.dimred_thresholded_events.envelope_alpha = params.envelope_alpha;
cfg.dimred_thresholded_events.envelope_min_window_sec = params.envelope_min_window_sec;
cfg.dimred_thresholded_events.envelope_max_window_sec = params.envelope_max_window_sec;
cfg.dimred_thresholded_events.envelope_fallback_window_sec = params.envelope_fallback_window_sec;
...
if local_has_time_metadata(observable_file)
    return;
end

fallback_file = fullfile(processed_root, dataset_name, ...
    io_project.get_pipeline_stage_name(1, 'dictionary'), ...
    sprintf('%s_low50_high250_g2_abs_single.mat', dataset_name));
if ~strcmpi(observable_file, fallback_file) && ...
        exist(fallback_file, 'file') == 2 && local_has_time_metadata(fallback_file)
    fprintf(['  [metadata] %s lacks dt/session metadata; using abs ', ...
        'dictionary metadata:\n    %s\n'], observable_file, fallback_file);
    observable_file = fallback_file;
end
end


function tf = local_has_time_metadata(file_name)
tf = false;
try
