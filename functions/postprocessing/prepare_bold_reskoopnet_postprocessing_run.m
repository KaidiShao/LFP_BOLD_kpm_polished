...
if isempty(dir(fullfile(run_info.output_dir, params.filename_pattern))) && ...
        allow_summary_only
    [ctx.EDMD_outputs, ctx.concat_info, ctx.source_info] = ...
