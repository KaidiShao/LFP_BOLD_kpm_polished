function spkt_row = build_spkt_residual_cross_correlation_row(run_info, save_dir, result, overview_png, overview_fig)
%BUILD_SPKT_RESIDUAL_CROSS_CORRELATION_ROW Build one SPKT result summary row.
...
out.spkt_cross_dir = string(save_dir);
out.spkt_result_mat = string(result.save_paths.main_mat);
...
spkt_row = struct2table(out, 'AsArray', true);
end
