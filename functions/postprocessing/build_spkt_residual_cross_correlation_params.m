function cmp_params = build_spkt_residual_cross_correlation_params(run_info, residual_bundle, save_dir, params)
%BUILD_SPKT_RESIDUAL_CROSS_CORRELATION_PARAMS Build SPKT xcorr params for one run.
...
cmp_params.residual.max_modes = params.spkt_cross_max_modes;
cmp_params.spike_channels = params.spkt_cross_channels;
cmp_params.output_root = params.processed_root;
cmp_params.save_dir = save_dir;
cmp_params.verbose = params.spkt_cross_verbose;
cmp_params.progress_every = params.spkt_cross_progress_every;
cmp_params.top_n_rows = params.spkt_cross_top_n_rows;
end
