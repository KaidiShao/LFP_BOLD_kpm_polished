function cfg = build_blp_eigenfunction_reduction_defaults()
%BUILD_BLP_EIGENFUNCTION_REDUCTION_DEFAULTS Canonical defaults for pipeline 5.
...
cfg.output = struct();
cfg.output.root = '';
cfg.output.figure_dir = '';
cfg.output.result_dir = '';
cfg.output.source_run_name = '';
cfg.output.output_run_name = '';
...
cfg.viz.overview.component_source = 'smooth_if_available';
...
cfg.viz.state_space.scatter_marker_size = 10;
cfg.viz.state_space.scatter_alpha = 0.84;
...
cfg.viz.state_space_consensus.component_source = 'smooth_if_available';
...
cfg.viz.state_space_consensus.scatter_marker_size = 12;
cfg.viz.state_space_consensus.scatter_alpha = 0.88;
...
cfg.viz.state_space_consensus.save_dir = '';
...
cfg.thresholded_density.threshold_mode = 'quantile';
cfg.thresholded_density.value_transform = 'abs';
cfg.thresholded_density.lfp_activity_transform = 'abs_magnitude';
cfg.thresholded_density.lfp_activity_window_policy = 'samplewise_abs_no_envelope';
cfg.thresholded_density.envelope_enable = false;
cfg.thresholded_density.envelope_policy = 'none';
cfg.thresholded_density.envelope_alpha = 0.35;
cfg.thresholded_density.envelope_min_window_sec = 0.03;
cfg.thresholded_density.envelope_max_window_sec = 1.0;
cfg.thresholded_density.envelope_fallback_window_sec = 0.10;
...
cfg.thresholded_density.observable_file = '';
...
cfg.thresholded_density.save_stem = 'eigenfunction_thresholded_density';
cfg.thresholded_density.save_tag = 'run';
...
cfg.thresholded_events.event_detector = 'find_peak_loc';
...
cfg.thresholded_events.observable_file = '';
cfg.thresholded_events.nms = struct();
cfg.thresholded_events.nms.enable = true;
cfg.thresholded_events.nms.mode = 'eigen_period';
...
cfg.thresholded_events.save_stem = 'eigenfunction_thresholded_events';
cfg.thresholded_events.save_tag = 'run';
...
cfg.dimred_thresholded_density.value_transform = cfg.thresholded_density.value_transform;
cfg.dimred_thresholded_density.lfp_activity_transform = cfg.thresholded_density.lfp_activity_transform;
cfg.dimred_thresholded_density.lfp_activity_window_policy = cfg.thresholded_density.lfp_activity_window_policy;
cfg.dimred_thresholded_density.envelope_enable = cfg.thresholded_density.envelope_enable;
cfg.dimred_thresholded_density.envelope_policy = cfg.thresholded_density.envelope_policy;
cfg.dimred_thresholded_density.envelope_alpha = cfg.thresholded_density.envelope_alpha;
cfg.dimred_thresholded_density.envelope_min_window_sec = cfg.thresholded_density.envelope_min_window_sec;
cfg.dimred_thresholded_density.envelope_max_window_sec = cfg.thresholded_density.envelope_max_window_sec;
cfg.dimred_thresholded_density.envelope_fallback_window_sec = cfg.thresholded_density.envelope_fallback_window_sec;
cfg.dimred_thresholded_density.component_timescale_weight_transform = 'abs';
cfg.dimred_thresholded_density.component_timescale_top_modes = 5;
...
cfg.dimred_thresholded_density.observable_file = '';
...
cfg.dimred_thresholded_density.save_stem = 'eigenfunction_dimred_thresholded_density';
cfg.dimred_thresholded_density.save_tag = 'run';
...
cfg.dimred_thresholded_events.observable_file = '';
...
cfg.dimred_thresholded_events.save_stem = 'eigenfunction_dimred_thresholded_events';
cfg.dimred_thresholded_events.save_tag = 'run';
