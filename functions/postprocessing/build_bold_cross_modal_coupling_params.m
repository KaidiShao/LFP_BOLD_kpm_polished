...
params.current_p7_run_names = {};
params.current_p7_autodl_roots = build_bold_reskoopnet_postprocessing_params().autodl_roots;
...
params.blp_dimred_method_tags = local_default_blp_dimred_method_tags();
...
% Default pipeline is numeric-first: write MAT/CSV tables, then build compact
% cross-session/cross-method figures in P11-derived summary scripts.
params.xcorr.make_figures = false;
...
params.activation.enabled = false;
...
params.roi_summary.enabled = false;
...
function tags = local_default_blp_dimred_method_tags()
