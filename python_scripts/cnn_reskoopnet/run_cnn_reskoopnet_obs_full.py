...
def parse_args():
    ...
    default_output_parent = repo_root / 'results' / 'cnn_reskoopnet_runs'
    ...
    parser.add_argument('--run-name-base', default='cnn_obs_full')
...
def main():
    ...
    mat_filename = f'f12m01_low50_high250_g2_{ARGS.observable_mode}_single.mat'
    info_csv_filename = f'f12m01_low50_high250_g2_{ARGS.observable_mode}_single_obs_info.csv'
    mat_path = ARGS.data_root / mat_filename
    info_csv_path = ARGS.data_root / info_csv_filename

    run_label = f'{ARGS.run_name_base}_{ARGS.observable_mode}_{ARGS.device}'
    run_root = ARGS.output_parent / run_label
    checkpoint_root = run_root / 'checkpoints'
    output_root = run_root / 'exports'
