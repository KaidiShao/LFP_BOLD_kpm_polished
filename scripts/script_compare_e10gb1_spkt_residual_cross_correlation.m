...
result = compute_spkt_residual_cross_correlation(cfg, params);
result = save_spkt_residual_cross_correlation_result(result, params.save_dir);

fprintf('\nSaved SPKT-residual cross-correlation outputs:\n');
