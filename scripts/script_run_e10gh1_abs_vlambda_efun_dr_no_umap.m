% Run E10.gH1 abs/projected_vlambda eigenfunction dimension reduction.
%
% This uses the completed fixed E10.gH1 abs-vlambda MLP run and
% intentionally excludes UMAP for now. It reuses the shared batch runner so
% outputs land in:
%   E:\DataPons_processed\e10gh1\efun\abs_vlambda\<method>\
...
efun_batch_override.run_key_filter = {'e10gh1/abs_vlambda'};
...
fprintf('Running E10.gH1 abs-vlambda eigenfunction DR without UMAP.\n');
