#!/usr/bin/env python3
"""Run A13 BOLD P4 standardized roi_mean training on CPU."""
...
queue.MAIN_LOG = queue.RUN_LOG_DIR / "bold_cpu_a13_roi_mean_stdT_p4_queue_20260611.log"
queue.THREAD_ENV = {
    **queue.THREAD_ENV,
    "OMP_NUM_THREADS": "4",
...
def _summary_path(group: str) -> Path:
    return queue.RUN_LOG_DIR / "bold_cpu_a13_roi_mean_stdT_p4_queue_20260611_summary.json"
