...
figure_dir = io_project.get_pipeline_stage_dir(output_root, cfg, 6, 'figures_spkt_residual_cross_correlation');
result_file = '';
...
sgtitle('E10gb1 SPKT vs LFP Residual Cross-Correlation (zero lag)', 'FontWeight', 'bold');
