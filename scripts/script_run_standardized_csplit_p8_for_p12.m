% Run P8 xcorr for standardized complex-split RMS-envelope BLP density.
%
% This is the P12 narrative-validation branch:
%   event density vs raw csplit density vs dimred csplit density
%   using complex_split_projected_vlambda_standardize_rmsenv_adaptive.
%
...
for i_cfg = 1:numel(cfg_names)
    ...
    xcorr_save_tag = 'xcorr_csplit_standardize_rmsenv_adaptive'; %#ok<NASGU>
