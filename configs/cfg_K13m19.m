function cfg = cfg_K13m19()
% Configuration for dataset K13.m19
% Primary reference: D:\Onedrive\ICPBR\forNikos\MatLab\DESNET\sesmonkeys\K13m19.m
...
%% basic info
cfg.dataset_id = 'K13.m19';
cfg.raw_data_root = 'E:\DataPons\K13.m19\';
cfg.data_subfolder = 'blp';
cfg.file_stem = 'k13m19';

%% channel selection
cfg.channels.sites = {      'hp'  'pl'  'pl'  'hp'        'hp'  'hp'  'hp'  'hp' ...
                 'po'  'pbn'  'po'  'po'        'po'  'po'  'po'  'po'  'pbn' };
cfg.channels.selected_labels = {'hp', 'pl'};
cfg.channels.selected_site1 = [1, 4:8];
cfg.channels.selected_site2 = [2, 3];
cfg.channels.selected_all = [1:8];

%% session selection
cfg.sessions = struct([]);

cfg.sessions(1).session_id = 1:9;
...
cfg.sessions(3).session_id = 17:20;
