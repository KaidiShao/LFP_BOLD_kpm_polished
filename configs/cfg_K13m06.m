function cfg = cfg_K13m06()
% Configuration for dataset K13.m06
% Primary reference: D:\Onedrive\ICPBR\forNikos\MatLab\DESNET\sesmonkeys\K13m06.m
% Kaidi Shao, 20260611

%% basic info
cfg.dataset_id = 'K13.m06';
cfg.raw_data_root = 'G:\DataPons\K13.m06\';
cfg.data_subfolder = 'blp';
cfg.file_stem = 'k13m06';

%% channel selection
cfg.channels.sites = {'hp', 'hp', 'hp', 'pl', 'pl', 'hp', 'hp', 'pl', ...
                      'pbn', 'po', 'po', 'po', 'po', 'pbn', 'po', 'pbn', 'pbn'};
cfg.channels.selected_labels = {'hp', 'pl'};
cfg.channels.selected_site1 = [1:3, 6:7];
cfg.channels.selected_site2 = [4:5, 8];
...
cfg.sessions(2).session_id = 11:15;
