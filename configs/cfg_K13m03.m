function cfg = cfg_K13m03()
% Configuration for dataset K13.m03
% Primary reference: D:\Onedrive\ICPBR\forNikos\MatLab\DESNET\sesmonkeys\K13m03.m
% Kaidi Shao, 20260611

%% basic info
cfg.dataset_id = 'K13.m03';
cfg.raw_data_root = 'G:\DataPons\K13.m03\';
cfg.data_subfolder = 'blp';
cfg.file_stem = 'k13m03';

%% channel selection
cfg.channels.sites = {'hp', 'hp', 'hp', 'hp', 'pl', 'pl', 'hp', 'pl', 'hp', ...
                      'pbn', 'po', 'po', 'po', 'po', 'pbn', 'pbn', 'pbn', 'NOS'};
cfg.channels.selected_labels = {'hp', 'pl'};
cfg.channels.selected_site1 = [1:4, 7, 9];
cfg.channels.selected_site2 = [5:6, 8];
cfg.channels.selected_all = [cfg.channels.selected_site1, cfg.channels.selected_site2];

%% session selection
cfg.sessions = struct([]);

cfg.sessions(1).session_id = 2:11;
