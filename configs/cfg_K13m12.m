function cfg = cfg_K13m12()
% Configuration for dataset K13.m12
% Primary reference: D:\Onedrive\ICPBR\forNikos\MatLab\DESNET\sesmonkeys\K13m12.m
% Kaidi Shao, 20260611

%% basic info
cfg.dataset_id = 'K13.m12';
cfg.raw_data_root = 'G:\DataPons\K13.m12\';
cfg.data_subfolder = 'blp';
cfg.file_stem = 'k13m12';
...
cfg.sessions(2).session_id = 12:20;
