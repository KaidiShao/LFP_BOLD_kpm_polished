function cfg = cfg_CM029qf1()
% Configuration for dataset CM029.qf1
% Primary reference: D:\Onedrive\ICPBR\forNikos\MatLab\DESNET\sesmonkeys\CM029qf1.m
% NOTE: current G:\DataPons\CM029.qf1 contains no data files.
% Kaidi Shao, 20260611

%% basic info
cfg.dataset_id = 'CM029.qf1';
cfg.raw_data_root = 'G:\DataPons\CM029.qf1\';
cfg.data_subfolder = 'blp';
cfg.file_stem = 'cm029qf1';

%% channel selection
% Source sites are LGN/ST-PONS, not HP/PL. The current mainline keeps HP/PL
% channels, so no session is marked runnable here.
cfg.channels.sites = {'lgn', 'lgn', 'NOS', 'lgn', 'lgn', 'st', 'st', 'lgn', 'lgn', ...
                      'pbn', 'po', 'NOS', 'pbn', 'po', 'po', 'po', 'po', 'pbn'};
...
cfg.sessions(2).session_id = 11:13;
