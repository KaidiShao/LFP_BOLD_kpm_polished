function cfg = cfg_K13m08()
% Configuration for dataset K13.m08
% Primary reference: D:\Onedrive\ICPBR\forNikos\MatLab\DESNET\sesmonkeys\K13m08.m
% Kaidi Shao, 20260611

%% basic info
cfg.dataset_id = 'K13.m08';
cfg.raw_data_root = 'G:\DataPons\K13.m08\';
cfg.data_subfolder = 'blp';
cfg.file_stem = 'k13m08';

%% channel selection
cfg.channels.sites = {'hp', 'hp', 'pl', 'pl', 'pl', 'pl', 'hp', ...
                      'po', 'po', 'pbn', 'po', 'po', 'pbn', 'pbn'};
cfg.channels.selected_labels = {'hp', 'pl'};
cfg.channels.selected_site1 = [1:2, 7];
cfg.channels.selected_site2 = 3:6;
