function cfg = cfg_K13m15()
% Configuration for dataset K13.m15
% Primary reference: D:\Onedrive\ICPBR\forNikos\MatLab\DESNET\sesmonkeys\K13m15.m
% Kaidi Shao, 20260611

%% basic info
cfg.dataset_id = 'K13.m15';
cfg.raw_data_root = 'G:\DataPons\K13.m15\';
cfg.data_subfolder = 'blp';
cfg.file_stem = 'k13m15';

%% channel selection
cfg.channels.sites = {'hp', 'hp', 'hp', 'hp', 'hp', 'pl', 'pl', 'pl', 'hp', ...
                      'po', 'pbn', 'pbn', 'po', 'pbn', 'pbn', 'po'};
cfg.channels.selected_labels = {'hp', 'pl'};
cfg.channels.selected_site1 = [1:5, 9];
cfg.channels.selected_site2 = 6:8;
...
cfg.sessions(2).session_id = 11:18;
