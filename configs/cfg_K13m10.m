function cfg = cfg_K13m10()
% Configuration for dataset K13.m10
% Primary reference: D:\Onedrive\ICPBR\forNikos\MatLab\DESNET\sesmonkeys\K13m10.m
% Kaidi Shao, 20260611

%% basic info
cfg.dataset_id = 'K13.m10';
cfg.raw_data_root = 'G:\DataPons\K13.m10\';
cfg.data_subfolder = 'blp';
cfg.file_stem = 'k13m10';

%% channel selection
cfg.channels.sites = {'hp', 'pl', 'pl', 'pl', 'hp', 'hp', 'pbn', ...
                      'NOS', 'NOS', 'po', 'NOS', 'pbn', 'po'};
cfg.channels.selected_labels = {'hp', 'pl'};
cfg.channels.selected_site1 = [1, 5:6];
