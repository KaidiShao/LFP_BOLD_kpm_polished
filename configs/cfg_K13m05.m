function cfg = cfg_K13m05()
% Configuration for dataset K13.m05
% Primary reference: D:\Onedrive\ICPBR\forNikos\MatLab\DESNET\sesmonkeys\K13m05.m
% Kaidi Shao, 20260611

%% basic info
cfg.dataset_id = 'K13.m05';
cfg.raw_data_root = 'G:\DataPons\K13.m05\';
cfg.data_subfolder = 'blp';
cfg.file_stem = 'k13m05';

%% channel selection
cfg.channels.sites = {'pl', 'hp', 'hp', 'hp', 'hp', 'pl', 'po', 'po', ...
                      'po', 'po', 'pbn', 'pbn', 'pbn', 'pbn', 'pbn'};
cfg.channels.selected_labels = {'hp', 'pl'};
cfg.channels.selected_site1 = 2:5;
cfg.channels.selected_site2 = [1, 6];
cfg.channels.selected_all = [cfg.channels.selected_site1, cfg.channels.selected_site2];

%% session selection
cfg.sessions = struct([]);

cfg.sessions(1).session_id = 4:13;
